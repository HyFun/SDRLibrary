...
public abstract class BaseSimpleFragment extends Fragment implements OnScrollListener  {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        StatusBarUtils.setTranslucentImageHeader(getActivity(), onHeaderBarStatusViewAlpha(), toolBar);
