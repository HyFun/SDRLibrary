...
public class RoundFrameLayout extends FrameLayout {
    ...
    private Paint roundPaint, imagePaint;
    ...
    public void setRadius(float topLeft, float topRight, float botLeft, float botRight) {
        topLeftRadius = topLeft;
        topRightRadius = topRight;
        bottomLeftRadius = botLeft;
        bottomRightRadius = botRight;
        postInvalidate();
    }
