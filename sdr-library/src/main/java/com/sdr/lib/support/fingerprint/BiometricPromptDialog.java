 ...
 */
class BiometricPromptDialog extends DialogFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.sdr_layout_biometric_prompt_dialog, container);
    ...
    public void setState(int state) {
        switch (state) {
            case STATE_NORMAL:
                ...
                mStateTv.setText("触摸感应指纹");
                break;
            case STATE_FAILED:
                mStateTv.setTextColor(Color.parseColor("#FF5555"));
                mStateTv.setText("指纹验证失败，请重试");
                break;
            case STATE_ERROR:
                mStateTv.setTextColor(Color.parseColor("#FF5555"));
